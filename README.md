...
1. Unit tests. Simple unit test framework (UnitTest++) has been used. A
...
2. Automated tests. The project uses CTest (delivered with CMake) to
...
3. Two test applications which have been used during development to test
